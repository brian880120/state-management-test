...
pub enum TextSubCommand {
    ...
    #[command(about = "Verify a message signature")]
    Verify(TextVerifyOpts),

    #[command(about = "Generate a new private/shared key")]
...
impl CmdExector for TextVerifyOpts {
    async fn execute(self) -> anyhow::Result<()> {
        let verified = process_text_verify(&self.input, &self.sig, self.format, &self.key)?;
